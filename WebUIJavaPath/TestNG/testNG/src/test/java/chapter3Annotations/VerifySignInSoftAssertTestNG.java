...
public class VerifySignInSoftAssertTestNG{
    ...
    public void setUp ()
    {
       // System.setProperty("webdriver.chrome.driver", "C:\\Users\\SC\\Documents\\ChromeWebDriver\\Version 2.0\\chromedriver.exe");
    ...
    public void userSignOut ()
    {
     ...
     //   Highlighter.highlightElement(driver, linkWelcome);
        ...
        //Dropdown needed a wait unless element will not be captured
        driver.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS);

        WebElement linkLogout = driver.findElement(By.xpath("//div[@id='welcome-menu']/descendant::a[contains(@href,'logout')]"));  //div[contains(@id,'welcome-menu')]//a[contains(text(),'Logout')]
       // WebElement linkLogout = driver.findElement(By.xpath("//div[contains(@id,'welcome-menu')]//a[contains(text(),'Logout')]"));
