...
public class PDFTests extends BaseTestsPDF {
    ...
    public void testInvoices() throws IOException, InterruptedException {
        ...
        File downloadedPDF = new File("C://Users/SC/Downloads" + invoiceNumber + ".pdf");
        File destination = new File("resources/" + invoiceNumber + ".pdf" );
       // Assert.assertTrue(invoiceNumber + ".pdf file was not moved to test location", FileUtils.moveFile(downloadedPDF,destination));
